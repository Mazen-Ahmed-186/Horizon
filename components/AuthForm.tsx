            ...
            {user ? (
                ...
                <>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            <div className={"flex flex-col gap-4"}>
                                <Button type="submit" disabled={isLoading}
                                        className={"rounded-lg border border-bankGradient bg-bank-gradient font-semibold text-white shadow-form text-[16px] leading-[24px]"}>
                                    {isLoading ? (
                                        <>
                    ...
                    <footer className={"flex justify-center gap-1"}>
                        ...
                        <Link href={type === "sign-in" ? "/sign-up" : "/sign-in"} className={"text-[14px] leading-[20px] cursor-pointer font-medium text-bank-gradient"}>
